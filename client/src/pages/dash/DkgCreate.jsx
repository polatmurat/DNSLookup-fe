...
import { BsArrowLeft, BsBox } from "react-icons/bs";
      ...
      <Wrapper>
        <ScreenHeader>
          <h1 className="text-4xl screen-header-text">
            Domain Check Group Management
          </h1>
        </ScreenHeader>

        <Link
          to="/dashboard/dkg-control"
          ...
          <form className="w-full xl:w-8/12 p-3" onSubmit={createUser}>
            <div className="flex flex-wrap">
              ...
              <div className="w-full ml-3 p-3">
                <input
                  type="submit"
                  value={response.isLoading ? "Loading..." : "Create DKG"}
          ...
          {/* <div className="w-full xl:w-4/12 p-3">
            <div className="flex flex-wrap">
              <h1 className="text-gray-700 font-extralight mb-3">
                * Grup statüsü {"Pasif"} olarak işaretlenmiş gruplar kontrol
                dışı bırakılır.{" "}
              </h1>
